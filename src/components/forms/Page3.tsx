    ...
    <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
      ...
      <div className="mb-4">
        ...
        <Select onValueChange={onSelectChange} defaultValue={form.idType}>
          <SelectTrigger className=" shadow-sm p-2 border w-full border bg-indigo-50 text-gray-800">
...
/>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">
          Upload the document <span title="Optional" className="text-gray-400">ℹ️</span>
        </label>
        <input
          type="file"
